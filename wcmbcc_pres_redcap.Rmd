...
### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DATA&nbsp; `r emo::ji("arrow_right")` &nbsp; .golden[**SCRIPT**]&nbsp; `r emo::ji("arrow_right")` &nbsp; NEW DATA
...
### .golden[**Programmatically**] pulled (and cleaned) data
...
##  1. Change the .navy[**SQL**] data itself

##  .magnolia[**Pull**, **clean**, and .forest**send CSV**]

##  .magnolia[**Pull**, **clean**, and set up **REDCap**]
...
##  2. .forest[**Pull**], .forest[**clean**], and .forest[**send CSV**]
...
##  3. .cardinal[**Pull**], .cardinal[**clean**], and set up .cardinal[**REDCap**]
...
<li><img src="images/db.png" height=70px style="margin:10px 5px 5px 5px"></li>
<li><img src="images/rlogo.svg" height=70px style="margin:5px 5px 5px 15px"></li>
<li><img src="images/redcaprlogo.png" height=70px style="margin:5px 5px 5px 20px"></li>
<li><img src="images/redcap.png" height=70px style="margin:5px 5px 5px 15px"></li>
]
