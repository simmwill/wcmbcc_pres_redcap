...
Potential approaches and issues/cautions with each:
  ...
  - PI could manually-abstract data to be housed in SQL backend
    - Good long-term, but time-consuming, and what if only needed for small subset of patients?
  - 
...
Brief outline of what I did with R-REDCap API:
  ...
  - Freeze; create backup/sandbox REDCaps
  - Manual abstraction
  - Create separate pipeline for further REDCap structural updates
